...
const _abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: false,
        internalType: "enum IStore.Status",
        name: "status",
        type: "uint8",
      },
    ],
  ...
  },
  {
    ...
    name: "getLockedAssetTokenAmount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getWithdrawableAssetTokenAmount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "getWithdrawableGasTokenAmount",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract IStoreManager",
        name: "",
        type: "address",
      },
    ],
